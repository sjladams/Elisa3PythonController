...
class Node:
    ...
    def determine_camera(self, cameras):
        ...
        dist_odo_cam = math.sqrt((self.odom_x - cameras.measurement_list[idx][0]) ** 2 + (
                    self.odom_y - cameras.measurement_list[idx][1]) ** 2)
...
class Nodes:
    ...
    def store_data(self, t):
        ...
        for tag in self.nodes:
            ...
            self.saved_data[t][tag] = {'pos_x': copy.deepcopy(self.nodes[tag].odom_x),
                                       ...
                                       'speed': copy.deepcopy(self.nodes[tag].speed),
                                       'heading': copy.deepcopy(self.nodes[tag].angle)
                                       }
        # self.ax[ :-1] = self.ax[ 1:]
        # self.ay[ :-1] = self.ay[ 1:]
    ...
    def save_data(self, t):
        with open('./data/saved_data_t{}_RUN{}.p'.format(t, 4), 'wb') as fp:
